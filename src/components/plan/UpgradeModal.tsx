      ...
      <div className="bg-surface w-full max-w-lg mx-auto rounded-t-3xl p-6 pb-10">
        <div className="flex items-center justify-between mb-5">
          <div>
            ...
            <h2 className="text-xl font-bold text-ink mt-0.5">Desbloqueate</h2>
          </div>
        ...
        <p className="text-ink-soft text-sm mb-6">Sin contrato, cancelás cuando querés.</p>

        <ul className="space-y-3 mb-7">
          {PRO_FEATURES.map((f) => (
            <li key={f} className="flex items-start gap-3">
              <Check size={18} className="text-brand-600 mt-0.5 shrink-0" strokeWidth={2.5} />
